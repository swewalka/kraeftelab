...
export const PracticeInteractionView = ({ interaction, answer, onAnswerChange }: PracticeInteractionViewProps) => {
  if (interaction.type === "checkbox") {
    return <CheckboxInteractionView interaction={interaction} answer={answer} onAnswerChange={onAnswerChange} />;
  }
  if (interaction.type === "multiple-choice") {
    return <MultipleChoiceInteractionView interaction={interaction} answer={answer} onAnswerChange={onAnswerChange} />;
  }
  if (interaction.type === "canvas-click") {
    return <CanvasClickInteractionView interaction={interaction} answer={answer} onAnswerChange={onAnswerChange} />;
  }
  if (interaction.type === "matching") {
    return <MatchingInteractionView interaction={interaction} answer={answer} onAnswerChange={onAnswerChange} />;
  }
  if (interaction.type === "equation-builder") {
    return <EquationBuilderInteractionView interaction={interaction} answer={answer} onAnswerChange={onAnswerChange} />;
  }
