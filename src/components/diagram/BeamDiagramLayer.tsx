...
export const BeamDiagramLayer = ({ problem, solverResult, diagramConfig, mode, worldToCanvas }: BeamDiagramLayerProps) => {
  ...
  return (
    <Layer>
      <Line points={[beamStart.x, beamStart.y, beamEnd.x, beamEnd.y]} stroke="#111111" strokeWidth={4} lineCap="round" />
      ...
      {diagramConfig.dimensions.map((dimension) => (
        <DimensionLine
          key={`${dimension.startPointId}-${dimension.endPointId}-${dimension.label}`}
